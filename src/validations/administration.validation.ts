...
export const createAdministrationValidation = (payload: programTrackerInterface) => {
...
export const updateAdministrationValidation = (payload: programTrackerInterface) => {
    const Schema = Joi.object({
...
// export const administrationValidation = async (payload: programTrackerInterface) => {
//     const Schema = Joi.object({
//         programTracker_id: Joi.string().required(),
//         vacancy_id: Joi.string().required(),
//         unit: Joi.string().trim().required(),
...
//         start_date: Joi.date().required(),
//         end_date: Joi.date().required(),
//         onBoarding_date: Joi.date(),
//         template_suratPerjanjian: Joi.string(),
//         template_suratPeminjamanIDCard: Joi.string(),
//         template_logbook: Joi.string(),
//         template_laporan: Joi.string(),
//         link_group: Joi.string(),
//     });
