...
export const requestVacancyValidation = (payload: requestVacancyInterface) => {
    const Schema = Joi.object({
        ...
        status: Joi.string().valid("Approved", "approved", "Rejected", "rejected", "Waiting", "waiting"),
...
export const updateRequestVacancyValidation = (payload: requestVacancyInterface) => {
    const Schema = Joi.object({
