...
// import { createProductValidation, ProductInterface } from '../validations/product.validation'
...
//   const { error, value } = createProductValidation(req.body as ProductInterface)
//   if (error) {
